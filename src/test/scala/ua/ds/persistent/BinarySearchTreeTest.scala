...
class BinarySearchTreeTest extends FlatSpec with Matchers {
    ...
    "A BST" should "not contain not inserted value" in {
        val first = BinarySearchTree[Int]().insert(10).insert(20)
    ...
    "A BST" should "contain all inserted values" in {
        val tree = BinarySearchTree[Int]().insert(10).insert(20).insert(30).insert(40)
    ...
    "A BST" should "not contain removed value" in {
        val tree = BinarySearchTree[Int]().insert(30).insert(20).insert(10).insert(40).insert(50)
    ...
    "An Iterator" should "iterate pre order over tree" in {
        pending
        val tree = BinarySearchTree[Int]().insert(5).insert(2).insert(1).insert(4).insert(7).insert(6).insert(8)
